...
<main class="main-content">
    ...
    if (!empty($_POST)) {
        ...
        echo "<h1>Modifier un locataire</h1>";
        echo "<p>$message</p>";
    } else {
        ...
        <div class="form-sections">
            ...
            <div class="form-right">
                ...
                <div class="checkbox-group">
                    ...
                    <input type="checkbox" name="rgpd" id="rgpd" <?php echo isset($_POST['rgpd']) ? 'checked' : (($tenantInfo['rgpd'] ?? false) ? 'checked' : ''); ?>>
                </div>
                <div class="checkbox-group">
                    <label for="receipt">Je souhaite recevoir une quittance de loyer chaque mois.</label>
                    <input type="checkbox" name="receipt" id="receipt" <?php echo isset($_POST['receipt']) ? 'checked' : (($tenantInfo['receipt'] ?? false) ? 'checked' : ''); ?>>
                </div>
                <div>
                    <label for="gender">Genre :</label>
                    <select name="gender" id="gender">
                        <option value="0" <?php echo (isset($_POST['gender']) && $_POST['gender'] == 0) ? 'selected' : (($tenantInfo['gender'] ?? 0) == 0 ? 'selected' : ''); ?>>Homme</option>
                        <option value="1" <?php echo (isset($_POST['gender']) && $_POST['gender'] == 1) ? 'selected' : (($tenantInfo['gender'] ?? 0) == 1 ? 'selected' : ''); ?>>Femme</option>
                    </select>
                </div>
                <div>
