    ...
    <main class="main-content">
        ...
        <form class="form-card" action="#" method="post">
            <div class="form-sections">
                <div class="form-left">
                    ...
                    <div>
                        ...
                        <input type="tel" name="landlinePhoneNumber" id="landlinePhoneNumber"
                            value="<?php echo isset($_POST['landlinePhoneNumber']) ? htmlspecialchars($_POST['landlinePhoneNumber']) : ''; ?>">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="additionalAddress" id="additionalAddress"
                            value="<?php echo isset($_POST['additionalAddress']) ? htmlspecialchars($_POST['additionalAddress']) : ''; ?>">
                    </div>
                </div>
                <div class="form-right">
                    <div>
                        ...
                        <input type="text" name="cityName" id="cityName"
                            value="<?php echo isset($_POST['cityName']) ? htmlspecialchars($_POST['cityName']) : ""; ?>">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="country" id="country"
                            value="<?php echo isset($_POST['country']) ? htmlspecialchars($_POST['country']) : 'France'; ?>">
                    </div>
                    <div>
                    ...
                    <div class="checkbox-group">
                        ...
                        <input type="checkbox" name="rgpd" id="rgpd"
                            <?php echo isset($_POST['rgpd']) ? 'checked' : ''; ?>>
                    </div>
                    ...
                    <div class="checkbox-group">
                        ...
                        <input type="checkbox" name="receipt" id="receipt"
                            <?php echo isset($_POST['receipt']) ? 'checked' : ''; ?>>
                    </div>
                    <div>
                        <label for="ownerNote">Note du propriétaire :</label>
                        <textarea id="ownerNote" name="ownerNote"><?= htmlspecialchars($_POST['ownerNote'] ?? '') ?></textarea>
                    </div>
                    <div>
            ...
            <div class="form-footer">
                <button type="submit">AJOUTER LE LOCATAIRE</button>
            </div>
        </form>
    </main>
