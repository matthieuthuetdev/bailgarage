...
<main class="main-content">
    ...
    <div class="table-container">
        <table class="lease-table">
            <thead>
                <tr>
                    <th>Nom et Prénom du locataire</th>
                    <th>Adresse et numéro du garage</th>
                    <th>Date de début</th>
                    <th>Date de fin</th>
                    <th>Statut</th>
                    <th>Plus d'info</th>
            ...
            <tbody>
                ...
                foreach ($liste as $row) {
                    ...
                    echo "<td><a href='index.php?pageController=lease&action=display&id=" . $row["id"] . "' class='info-link'><i class='fa-solid fa-info'></i></a></td>";
                    echo "<td><a href='index.php?pageController=lease&action=update&id=" . $row["id"] . "' class='edit-link'><i class='fa-solid fa-pen-to-square'></i></a></td>";
                    echo "<td><a href='index.php?pageController=lease&action=delete&id=" . $row["id"] . "' class='delete-link'><i class='fa-solid fa-trash'></i></a></td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
