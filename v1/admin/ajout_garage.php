...
// Redirection si l'utilisateur n'est pas connecté ou n'est pas un administrateur
...
<body>
    ...
    <div class="container">
        ...
        <?php endif; ?>
        <form action="ajout_garage.php?proprietaire_id=<?php echo $proprietaire_id; ?>" method="post" enctype="multipart/form-data">
