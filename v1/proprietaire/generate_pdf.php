...
// Chemin de l'image de la signature du propriétaire
$signature_path = $proprietaire['piece_jointe_path'];
...
<p>Il a été remis au locataire par le bailleur <span>' . htmlspecialchars($bail['nombre_de_clefs']) . '</span> clé(s) et
  <span>' . htmlspecialchars($bail['nombre_de_bips']) . '</span> télécommande (s) du portail
</p>
...
<div class="signature">
  <div class="signature-line"></div>
  <div class="signature-position">Signature du propriétaire:»</div>
  <br>
  <br>
  <br>
  <br>
  <br>
  <div class="signature-line"></div>
  <div class="signature-position">Signature du locataire:»</div>
  <br>
  <br>
  <br>
  <br>
...
if (file_exists($signature_path)) {
    $pdf->Image($signature_path, 80, 95, 40); // Ajustez les coordonnées selon vos besoins
}
