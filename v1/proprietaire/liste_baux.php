...
// Récupérer les informations des baux du propriétaire connecté à partir des garages
...
$stmt_baux->bindParam(':user_id', $user_id);
$stmt_baux->execute();
...
<body>
    <div class="container">
        ...
        <div class="container-baux">
            ...
            <a href="bail.php"><i class="fas fa-plus"></i>Créer un Bail</a><br><br>
